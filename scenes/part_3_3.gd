...
var sceneName = "MUERTEPLAYER"
var sceneCodeTxt = "player_dead_txt"
var visualNovelName = "MUERTEPLAYER"
...
func mostrar_acto(acto_numero, actos):
	...
	if acto_numero in actos:
		...
		if acto_numero == 22:
			...
			$"../../GemidoLeve".play()
			$"../../GemidoLeve2".stream = load("res://sound/sounds/GEMIDO/GEMIDO_FUERTE3.ogg")
			$"../../GemidoLeve2".play()
			$"../../moanRandom".stream = load("res://sound/sounds/H_FellaUrgency.ogg")
			$"../../moanRandom".play()
			$"../../Effect".visible = true
			$"../../Effect".play("SPEED")
		...
		$"../../GemidoLeve".stream = load("res://sound/sounds/END/PLAYER_LAST_WHISPER.ogg")
		$"../../GemidoLeve".play()

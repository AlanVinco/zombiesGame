...
var sceneName = "OLVIDAR"
var sceneCodeTxt = "olvidar_txt"
var visualNovelName = "OLVIDAR"
...
func mostrar_acto(acto_numero, actos):
	...
	if acto_numero in actos:
		...
		if acto_numero >= 7 and acto_numero <=15:
			$"../..".shake_camera(1.0, 8)
		
		if acto_numero == 38:
			$"../../GemidoLeve".stream = load("res://sound/sounds/END/RISAS_END.ogg")
			$"../../GemidoLeve".play()
			
		if acto_numero == 26:
			$"../..".shake_camera(1.0, 8)
		if acto_numero >= 28 and acto_numero <= 41:
			$"../..".shake_camera(1.0, 8)
		if acto_numero == 42:
			$"../..".shake_camera(10.0, 15)
